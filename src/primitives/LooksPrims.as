...
public class LooksPrims {
	...
	public function addPrimsTo(primTable:Dictionary):void {
		...
		primTable['previousCostume']        = primPrevCostume;
...
//		primTable['yScroll']				= function(b:*):* { return app.stagePane.yScroll };
	...
	private function primHideAll(b:Block):void {
		// Hide all sprites and delete all clones.
	...
	private function primShowing(b:Block):Boolean {
		var s:ScratchSprite = interp.targetSprite();
		return s.visible;
	}
