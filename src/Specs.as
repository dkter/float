...
// Specs.as
// Originally by John Maloney, April 2010
// Modified by David Teresi, June 2014
//
...
public class Specs {
	...
	public static const categories:Array = [
	 // id   category name	color
		...
		[2,  "Looks",		0x8a55d7],
		[3,  "Sound",		0xbb42c3],
		[4,  "Pen",			0x009870], // Scratch: 0x0e9a6c
		[5,  "Events",		0xc88330], // Scratch: 0xc88330
		[6,  "Control",		0xe1a91a],
		[7,  "Sensing",		0x2ca5e2],
	...
	public static var commands:Array = [
		...
		["previous costume",                    " ", 2, "previousCostume"],
		...
		// sensing
		["touching %m.touching?",				"b", 7, "touching:",			"edge"],
		...
		// files
		//["read file %s",                                    "r", 13, "readFile:", "C:\\"],           //doesn't work
		//["write %s to file %s",                             " ", 13, "write:toFile:", "", "C:\\"],   //^^^^^^^^^^^^
		//["-"],
		["save %s to file as %s",                             " ", 13, "save:toFile:", "", "file.txt"],
